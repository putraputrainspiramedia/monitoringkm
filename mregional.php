...
<script language="javascript">
		...
		function hapusdata(id,nama){
			...
			$("#id").val(id);
			$("#nama").val(nama);
			$('.modal-title').html('Hapus Master Regional');
		...
		$(document).ready(function(){
			...
			$("#tambah").click(function () {
				...
				$("#hapus2").hide();
				$("#simpan").show();
				$('.modal-title').html('Input Master Regional');
           		$('#InputModalForms').modal('show');
       		});
			<?php } 
