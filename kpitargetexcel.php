...
$objPHPExcel->getProperties()->setCreator("Andex Teddy / exnome@gmail.com")
							 ...
							 ->setTitle("KPI Target")
							 ->setSubject("KPI Target")
							 ->setDescription("KPI Target")
							 ->setKeywords("KPI Target")
							 ->setCategory("KPI Target");
...
$objPHPExcel->getActiveSheet()->setTitle('KPI Target');
